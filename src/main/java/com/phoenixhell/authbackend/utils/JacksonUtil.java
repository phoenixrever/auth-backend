...
public class JacksonUtil {
    ...
    public static ObjectMapper getObjectMapper() {
        if (objectMapper == null) {
            ObjectMapper retrieval = new ObjectMapper();
            retrieval.configure(DeserializationFeature.ACCEPT_SINGLE_VALUE_AS_ARRAY, true);
            retrieval.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
            retrieval.configure(DeserializationFeature.FAIL_ON_IGNORED_PROPERTIES, false);
            retrieval.configure(DeserializationFeature.EAGER_DESERIALIZER_FETCH, false);
            retrieval.configure(SerializationFeature.EAGER_SERIALIZER_FETCH, false);
            objectMapper = retrieval;
        }
        return objectMapper;
    }
}
